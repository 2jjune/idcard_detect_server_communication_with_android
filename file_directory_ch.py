...
base_dir = 'C:/Users/USER/PycharmProjects/DexiNed/id_data/edges/imgs/train/rgbr/real/'
head_base_dir = 'C:/Users/USER/PycharmProjects/DexiNed/id_data/edges/imgs/val/rgbr/'
edge_img_dir = 'C:/Users/USER/PycharmProjects/DexiNed/id_data/edges/edge_maps/train/rgbr/real/'
head_edge_img_dir = 'C:/Users/USER/PycharmProjects/DexiNed/id_data/edges/edge_maps/val/rgbr/'

img_list = os.listdir(base_dir)
edge_img_list = os.listdir(edge_img_dir)

choice = random.sample(img_list, 800)

print(len(choice))
for img in choice:
    # print(img)
    shutil.move(base_dir+img,head_base_dir)
    shutil.move(edge_img_dir+img,head_edge_img_dir)
